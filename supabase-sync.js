(() => {
  ...
  const CONFIG = window.ParisSupabaseConfig || { url: 'https://bsbvvikslbugkipdjrzs.supabase.co', publishableKey: 'sb_publishable_j1LDWYxCGnAisYahnVYRRg_ImbkFPea' };
  ...
  async function start(options = {}) {
    if (startPromise && !options.force) return startPromise;
    startPromise = (async () => {
